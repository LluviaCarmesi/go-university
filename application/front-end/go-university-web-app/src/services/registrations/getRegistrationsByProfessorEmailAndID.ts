...
import { REGISTRATIONS_PROFESSOR_API_URI } from "../../appSettings";
import type IRegistration from "../../interfaces/IRegistration";

export default async function getRegistrationsByProfessorEmailAndID(emailAndID: string) {
    ...
    await fetch(`${REGISTRATIONS_PROFESSOR_API_URI}${emailAndID}`)
        .then((response) => {
